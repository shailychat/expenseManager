...
?>
<?php
//encrypting password form inputs
...
if ($newpass != $re_type_new_pass) {
    ...
    if (strlen($_POST['newpassword']) >= 6) {
        ...
        if ($row['password'] == $oldpass) {
            ...
            echo"<script> alert('Password Updated.')</script>"; //using javascript alert statement for showng user messages
            echo"<script>location.href='home.php'</script>";
        } else {
            echo"<script> alert('Wrong Old Password.')</script>"; //using javascript alert statement for showng user messages
            echo"<script>location.href='change_password.php'</script>";
        }
    } else {
        echo"<script> alert('Password Length must be greater than 6 characters')</script>"; //using javascript alert statement for showng user messages
        echo"<script>location.href='change_password.php'</script>";
    }
}
?>